...
(defn test-integration
  ...
  (testing "Pull diff from baseline has only inconsequential differences (ordering, etc)"
    (is (= "" (diff "--recursive" "--exclude" ".mirthsync-state.json" "--suppress-common-lines" "-I" ".*<contextType>.*" "-I" ".*<time>.*" "-I" ".*<timezone>.*" "-I" ".*<revision>.*" "-I" ".*<lastStatsTime>.*" repo-dir baseline-dir))))
  ...
  (testing "Pull diff from baseline after multiple pushes has only inconsequential differences (ordering, etc)"
    (is (= "" (diff "--recursive" "--exclude" ".DS_Store" "--exclude" ".mirthsync-state.json" "--suppress-common-lines" "-I" ".*<contextType>.*" "-I" ".*<time>.*" "-I" ".*<timezone>.*" "-I" ".*<revision>.*" "-I" ".*<lastStatsTime>.*" repo-dir baseline-dir))))
  ...
  (testing "Disk mode 1 pull and push works"
    (let [repo-dir (str repo-dir "-1")
      ...
      (is (= "" (diff "--exclude" ".DS_Store" "--exclude" ".mirthsync-state.json" "--recursive" "--suppress-common-lines" "-I" ".*<contextType>.*" "-I" ".*<time>.*" "-I" ".*<timezone>.*" "-I" ".*<revision>.*" "-I" ".*<lastStatsTime>.*" repo-dir baseline-dir)))
      (is (= 0 (do
                 (main-func "-s" "https://localhost:8443/api"
                            "-u" "admin" "-p" "admin" "-t" repo-dir
                            "-i" "-m" "groups" "push")))))))
